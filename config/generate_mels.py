...
def __generate_mels(entry, spec_model, device, use_beta_binomial_interpolator, mel_root):
    ...
    os.chdir("/home/irene/datasets/NemoSpanishTTS")
    # ../../datasets/datasetCastellanoReducido/19demarzo/19demarzo_3176.wav
    # ruta='/home/irene/datasets/datasetCastellanoReducido/19demarzo/19demarzo_.wav'
    audio = __load_wav(entry["audio_filepath"])
    # audio = __load_wav(ruta)
    ...
    with torch.no_grad():
        ...
        # save_path = mel_root / f"{Path(ruta).stem}.npy"
